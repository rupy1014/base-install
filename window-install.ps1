...
Write-Host ""
Write-Host "  그래도 화면이 빈 채로 계속 멈춰 있으면(로그인 화면조차 안 뜸):" -ForegroundColor White
Write-Host "     → 회사/학교/공유기 방화벽·프록시가 인터넷 접속을 막는 경우입니다." -ForegroundColor Gray
Write-Host "       다른 네트워크(예: 휴대폰 핫스팟)에서 'claude' 를 다시 시도해 보세요." -ForegroundColor Gray
Write-Host ""
